...
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) - Low-code Multi-AI Agents framework with YAML configuration, 100+ LLM support, MCP integration, and agentic workflows.
...
* [Rierino](https://rierino.com/) - Low-code platform for visually building and orchestrating backend microservices, API flows, and event-driven workflows with embedded AI agent capabilities.
