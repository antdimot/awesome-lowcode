...
* [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring and x402 payment verification MCP server for AI agents on Solana. Free wallet scoring, paid trust receipts via HTTP 402.
